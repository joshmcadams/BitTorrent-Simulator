 ...
 * peer and a remote peer. The interface is built and named from the perspective
 * of the local peer/client.
 *
 * @author jmcadams
 */
public interface PeerState {
  /**
   * Pieces sent between peers are noted by a piece transfer object that logs
   * relevant information about the transfer. This interface is primarily used
   * as a base for {@link PieceUpload} and {@link PieceDownload} interfaces.
   */
  ...
  public interface PieceDownload extends PieceTransfer {
    /**
     * Set this value to true if the piece that was transferred was a valid
     * piece. If the piece failed checksumming or was invalid for some other
     * reason, set the value to false.
     *
     * @param wasValid
     */
  ...
  /**
   * When either the local or remote peer makes a request for a piece, that
   * request is logged in a piece request object.
   */
  ...
  /**
   * Remote peers declare which pieces they have. These declarations are
   * packaged in a piece declaration object.
   */
  ...
  /**
   * Return a boolean indicating whether or not the remote is choked or unchoked
   * an when it happened.
   *
   * @return
   */
  ...
  /**
   * Return a boolean indicating whether or not the local is choked or unchoked
   * an when it happened.
   *
   * @return
   */
  ...
  /**
   * Return how many handshakes the remote has sent.
   */
  Integer howManyHandshakesHasTheRemoteSent();
   ...
   * Return how many handshakes the remote has sent.
   */
  Integer howManyHandshakesHasTheLocalSent();
  ...
  /**
   * When the remote says that it is interested or uninterested in the local,
   * log it here.
   *
   * @param interest
   * @param when
  ...
  /**
   * When the local tells the remote it is interested or uninterested in the
   * remote, log it here.
   *
   * @param interest
   * @param when
